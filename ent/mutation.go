...
func (m *BookMutation) ClearBody() {
	m.body = nil
	m.clearedFields[book.FieldBody] = struct{}{}
}

// BodyCleared returns if the "body" field was cleared in this mutation.
func (m *BookMutation) BodyCleared() bool {
	_, ok := m.clearedFields[book.FieldBody]
	return ok
}
...
func (m *BookMutation) ResetBody() {
	m.body = nil
	delete(m.clearedFields, book.FieldBody)
}
...
func (m *BookMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(book.FieldBody) {
		fields = append(fields, book.FieldBody)
	}
	return fields
}
