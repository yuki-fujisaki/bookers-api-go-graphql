...
func BodyIsNil() predicate.Book {
	return predicate.Book(sql.FieldIsNull(FieldBody))
}

// BodyNotNil applies the NotNil predicate on the "body" field.
func BodyNotNil() predicate.Book {
	return predicate.Book(sql.FieldNotNull(FieldBody))
}
